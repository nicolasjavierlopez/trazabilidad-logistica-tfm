...
const translations = {
  en: {
    ...
    // Login
    welcome: "Welcome",
    connectMetaMask: "Connect MetaMask to access.",
    registrationSuccess: "Successful registration. An admin will approve your access shortly.",
  ...
  es: {
    ...
    // Login
    welcome: "Bienvenido",
    connectMetaMask: "Conecta MetaMask para acceder.",
    registrationSuccess:
      "Registro exitoso, se ha registrado correctamente y un moderador se encargará de aprobar su acceso.",
