    ...
    <Box className="min-h-screen flex flex-col bg-slate-50">
      ...
      <Box className="flex-1 p-6 max-w-5xl mx-auto w-full">
        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 3 }}>
          <Box>
            <Typography variant="h5" className="font-bold">{t("myTokens")}</Typography>
              ...
              <TableBody>
                {paginated.map((token) => (
                  <TableRow key={token.id.toString()} hover>
                    ...
                    <TableCell>
                      <Typography variant="body2" className="font-bold">{token.name}</Typography>
                      {token.parentId > 0n && (
                    ...
                    <TableCell align="right">
                      <Typography variant="body2" sx={{ fontFamily: "monospace" }}>{token.balance.toLocaleString()}</Typography>
                    </TableCell>
                    <TableCell>
              ...
              <DialogContent sx={{ pt: 2.5 }}>
                ...
                <Box sx={{ display: "flex", flexDirection: "column", gap: 1, mb: 3 }}>
                  {[
                    ...
                    { label: t("colBalance"), value: detailToken.balance.toLocaleString() },
